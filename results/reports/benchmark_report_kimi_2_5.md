...
- Generated (UTC): 2026-03-04T16:06:47.922670Z

## Executive Summary

- Regular validation: 6/7 (85.7%)
- Code Mode validation: 5/6 (83.3%)
- Avg execution time: Regular `53.67s` vs Code Mode `206.47s`
- Total tokens: Regular `64338` vs Code Mode `35880`
...
Regular Agent:
  ...
  Avg Execution Time: 53.67s
  Avg Iterations: 3.71
  Total Input Tokens: 58117
  Total Output Tokens: 6221

Code Mode Agent:
  Successful: 5/7
  Validation: 5/6 passed (83.3%)
  Avg Execution Time: 206.47s
  Avg Iterations: 2.00
  Total Input Tokens: 18388
  Total Output Tokens: 17492
  Iteration Failures: 0
  Tool Discrepancies: 0

Comparison:
  Code Mode time vs Regular: +284.7%
  Token difference (Code Mode - Regular): -28458
```
